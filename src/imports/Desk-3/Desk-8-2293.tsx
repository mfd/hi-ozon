import svgPaths from "./svg-nlxi67zk9p";
...
import imgWrap2 from "./dc7e645f5d627913ed68e0c959de70ba59078429.png";
import imgWrap3 from "./6825dca3c91cd79893eab4857766f3aeeafcd212.png";
import imgWrap4 from "./edad8c7a22e311cdbb1ed748620a6f956756c2f6.png";
import imgWrap5 from "./ab2566354d871c6fb1af25e9518cc9f3f8743fe0.png";
import imgWrap6 from "./7496c196fc95f4876a1dcd7f386b44168988670f.png";
import imgWrap7 from "./92edd8247f325e1a737553effa07b6e75f5e5b09.png";
import imgWrap8 from "./fce679d17a824869a75f49dc2613d3bbf9cf8b38.png";
import imgWrap9 from "./c917094ae258006a37acccae50f9fd5655c24ce6.png";
import imgWrap10 from "./f8bd281c252597987261f4f739ebf574ff336990.png";
import imgWrap11 from "./7376775cb3cc056252084284a540984caf61a70a.png";
import imgWrap12 from "./941d0fa13fd522e812dc3562f430267eb195489b.png";
import imgWrap13 from "./d2f52e6d68c548e9ead8e7289ffbca9ca8a9f74b.png";
import imgWrap14 from "./64f0c4e5a2a1e0df38cae6d5b2f58014911bef5a.png";
import imgWrap15 from "./86f2390f2c78c5e790f9b7ec24116da256094251.png";
import imgWrap16 from "./49dbec775e05ee120efc3b8a33b4ce62500d9f91.png";
import imgWrap17 from "./d44ff45b402c9dafcec79817f5d8b10f4c84e39a.png";
...
function Container() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-start leading-[0] not-italic overflow-clip relative shrink-0 text-[#1f1f1f] w-[750px]" data-name="Container">
      <div className="flex flex-col font-['SF_Pro_Display:Bold',sans-serif] justify-center relative shrink-0 text-[32px] tracking-[0.21px] w-full">
...
function ListItem() {
  return (
    <div className="content-stretch flex flex-col gap-[12px] items-center relative shrink-0 w-[750px]" data-name="listItem">
...
function Wrap2() {
  return (
    <div className="h-[86.13px] overflow-clip relative shrink-0 w-[153.12px]" data-name="wrap">
      <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgWrap2} />
      <div className="absolute h-[100px] left-[2px] top-[-10px] w-[151px]" data-name="image 1" />
    </div>
  );
}
...
function Wrap3() {
  return (
    <div className="h-[86.13px] overflow-clip relative shrink-0 w-[153.12px]" data-name="wrap">
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <img alt="" className="absolute left-0 max-w-none size-full top-0" src={imgWrap3} />
      </div>
      <div className="absolute h-[100px] left-[2px] top-[-10px] w-[151px]" data-name="image 1" />
    </div>
  );
    ...
    <div className="h-[86.13px] overflow-clip relative shrink-0 w-[153.12px]" data-name="wrap">
      <div aria-hidden="true" className="absolute inset-0 pointer-events-none">
        ...
        <div className="absolute inset-0 overflow-hidden">
          <img alt="" className="absolute left-0 max-w-none size-full top-0" src={imgWrap6} />
        </div>
      </div>
      <div className="absolute h-[100px] left-[2px] top-[-10px] w-[151px]" data-name="image 1" />
    </div>
  ...
  return (
    <div className="h-[86.13px] overflow-clip relative shrink-0 w-[153.12px]" data-name="wrap">
      <div aria-hidden="true" className="absolute inset-0 pointer-events-none">
        <img alt="" className="absolute max-w-none object-cover size-full" src={imgWrap4} />
        <img alt="" className="absolute max-w-none object-cover size-full" src={imgWrap5} />
        <img alt="" className="absolute max-w-none object-cover size-full" src={imgWrap7} />
      </div>
      <div className="absolute h-[100px] left-[2px] top-[-10px] w-[151px]" data-name="image 1" />
    </div>
  );
  ...
  return (
    <div className="h-[86.13px] overflow-clip relative shrink-0 w-[153.12px]" data-name="wrap">
      <div aria-hidden="true" className="absolute inset-0 pointer-events-none">
        <img alt="" className="absolute max-w-none object-cover size-full" src={imgWrap4} />
        <img alt="" className="absolute max-w-none object-cover size-full" src={imgWrap5} />
        <img alt="" className="absolute max-w-none object-cover size-full" src={imgWrap8} />
      </div>
      <div className="absolute h-[100px] left-[2px] top-[-10px] w-[151px]" data-name="image 1" />
    </div>
  );
...
function Wrap7() {
  return (
    <div className="h-[86.13px] overflow-clip relative shrink-0 w-[153.12px]" data-name="wrap">
      <div aria-hidden="true" className="absolute inset-0 pointer-events-none">
        <img alt="" className="absolute max-w-none object-contain size-full" src={imgWrap9} />
        <div className="absolute inset-0 overflow-hidden">
          <img alt="" className="absolute left-0 max-w-none size-full top-0" src={imgWrap10} />
        </div>
        <div className="absolute inset-0 overflow-hidden">
  ...
  return (
    <div className="h-[86.13px] overflow-clip relative shrink-0 w-[153.12px]" data-name="wrap">
      <div aria-hidden="true" className="absolute inset-0 pointer-events-none">
        <img alt="" className="absolute max-w-none object-cover size-full" src={imgWrap4} />
        <img alt="" className="absolute max-w-none object-cover size-full" src={imgWrap5} />
        <img alt="" className="absolute max-w-none object-cover size-full" src={imgWrap13} />
        <div className="absolute inset-0 overflow-hidden">
          <img alt="" className="absolute left-0 max-w-none size-full top-0" src={imgWrap3} />
        </div>
        <div className="absolute inset-0 overflow-hidden">
  ...
  return (
    <div className="h-[86.13px] overflow-clip relative shrink-0 w-[153.12px]" data-name="wrap">
      <div aria-hidden="true" className="absolute inset-0 pointer-events-none">
        ...
        <div className="absolute inset-0 overflow-hidden">
          <img alt="" className="absolute left-0 max-w-none size-full top-0" src={imgWrap17} />
        </div>
      </div>
      <div className="absolute h-[100px] left-[2px] top-[-10px] w-[151px]" data-name="image 1" />
    </div>
...
function CaseList() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="CaseList">
      <div className="content-stretch flex flex-col gap-[32px] items-start relative shrink-0 w-[750px]" data-name="CaseItem">
        <Container1 />
...
function Main() {
  return (
    <div className="content-stretch flex flex-col gap-[56px] items-start overflow-clip relative shrink-0 w-[750px]" data-name="Main">
      <Header />
      <SectionSkills />
      <SectionCase />
    </div>
...
function Left() {
  return (
    <div className="content-stretch flex items-start relative shrink-0 w-[1140px]" data-name="Left">
      <Main />
    </div>
  );
}
...
function Avatar() {
  return (
    <div className="relative rounded-[817.578px] shrink-0 size-[144px]" data-name="avatar">
      <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none rounded-[817.578px] size-full" src={imgAvatar} />
    </div>
  );
}
...
function List() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-start relative shrink-0 w-full" data-name="list">
      ...
      <div className="content-stretch flex flex-col items-start max-w-[1440px] overflow-clip relative shrink-0 w-full" data-name="dd-elem">
        <div className="flex flex-col font-['SF_Pro_Text:Regular',sans-serif] justify-center leading-[0] min-w-full not-italic relative shrink-0 text-[#828282] text-[20px] w-[min-content]">
          <p className="leading-[32px]">Email:</p>
        </div>
        <div className="content-stretch flex gap-[4px] items-center justify-center relative shrink-0" data-name="button">
          <div className="flex flex-col font-['SF_Pro_Text:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#1f1f1f] text-[0px] whitespace-nowrap">
            <a className="block cursor-pointer decoration-solid leading-[32px] text-[20px] underline" href="mailto:kashaev@gmail.com" target="_blank">
              kashaev@gmail.com
            </a>
          </div>
        </div>
...
function Right() {
  return (
    <div className="content-stretch flex flex-col gap-[24px] items-start overflow-clip pb-[32px] pointer-events-auto pt-[96px] sticky top-0 w-[260px]" data-name="Right">
      <Avatar />
      <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="SectionTitle">
        <div className="flex flex-col font-['SF_Pro_Display:Bold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#1f1f1f] text-[32px] tracking-[0.21px] w-full">
          <p className="leading-[48px]">Kamil Kashaev</p>
        </div>
      </div>
      <List />
    </div>
...
export default function Desk() {
  return (
    <div className="bg-white content-stretch flex flex-col items-center justify-center px-[32px] py-[96px] relative size-full" data-name="Desk">
      <Left />
      <div className="absolute bottom-0 h-[2980px] left-[1504px] pointer-events-none top-0">
        <Right />
      </div>
    </div>
  );
