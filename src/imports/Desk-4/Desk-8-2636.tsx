import svgPaths from "./svg-4wrscb3yqv";
...
function Main() {
  return (
    <div className="content-stretch flex flex-col gap-[56px] items-start overflow-clip relative shrink-0 w-[848px]" data-name="Main">
      <Header />
      <SectionSkills />
      <SectionCase />
    </div>
