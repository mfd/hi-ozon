import svgPaths from "./svg-73s1oppcrd";
...
function Main() {
  return (
    <div className="content-stretch flex flex-col gap-[56px] items-start overflow-clip relative shrink-0 w-[849px]" data-name="Main">
      <Header />
      <SectionSkills />
      <SectionCase />
    </div>
...
function Right() {
  return (
    <div className="content-stretch flex flex-col gap-[24px] items-start overflow-clip pb-[32px] pointer-events-auto pt-[96px] sticky top-0 w-[267px]" data-name="Right">
      <Avatar />
      <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="SectionTitle">
        <div className="flex flex-col font-['SF_Pro_Display:Bold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#1f1f1f] text-[32px] tracking-[0.21px] w-full">
...
export default function Desk() {
  return (
    <div className="bg-white content-stretch flex flex-col items-center justify-center px-[32px] py-[96px] relative size-full" data-name="Desk">
      <Left />
      <div className="absolute bottom-0 h-[2980px] left-[1503px] pointer-events-none top-0">
        <Right />
      </div>
    </div>
  );
