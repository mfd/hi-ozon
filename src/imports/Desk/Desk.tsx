import svgPaths from "./svg-py3rnz5y1j";
...
import imgWrap12 from "./f8bd281c252597987261f4f739ebf574ff336990.png";
import imgWrap13 from "./7376775cb3cc056252084284a540984caf61a70a.png";
import imgWrap14 from "./941d0fa13fd522e812dc3562f430267eb195489b.png";
import imgWrap15 from "./64f0c4e5a2a1e0df38cae6d5b2f58014911bef5a.png";
import imgWrap16 from "./86f2390f2c78c5e790f9b7ec24116da256094251.png";
import imgWrap17 from "./49dbec775e05ee120efc3b8a33b4ce62500d9f91.png";
import imgWrap18 from "./d44ff45b402c9dafcec79817f5d8b10f4c84e39a.png";
...
function Wrap7() {
  return (
    <div className="h-[86.13px] overflow-clip relative shrink-0 w-[153.12px]" data-name="wrap">
      <div aria-hidden="true" className="absolute inset-0 pointer-events-none">
        <img alt="" className="absolute max-w-none object-contain size-full" src={imgWrap11} />
        <div className="absolute inset-0 overflow-hidden">
  ...
  return (
    <div className="h-[86.13px] overflow-clip relative shrink-0 w-[153.12px]" data-name="wrap">
      <div aria-hidden="true" className="absolute inset-0 pointer-events-none">
        ...
        <div className="absolute inset-0 overflow-hidden">
          <img alt="" className="absolute left-0 max-w-none size-full top-0" src={imgWrap18} />
        </div>
      </div>
      <div className="absolute h-[100px] left-[2px] top-[-10px] w-[151px]" data-name="image 1" />
    </div>
